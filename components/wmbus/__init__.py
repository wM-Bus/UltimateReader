...
CONFIG_SCHEMA = cv.Schema({
    ...
    cv.Optional(CONF_MOSI_PIN,       default=11):      pins.internal_gpio_output_pin_schema,
    cv.Optional(CONF_MISO_PIN,       default=9):      pins.internal_gpio_input_pin_schema,
    cv.Optional(CONF_CLK_PIN,        default=10):      pins.internal_gpio_output_pin_schema,
