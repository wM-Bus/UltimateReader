...
void Supla::RegisterDevice::resetToDefaults() {
  ...
  memset(&deviceChannelStruct.version_E, 0,
         sizeof(deviceChannelStruct.version_E));
}
...
const char *Supla::RegisterDevice::getGUID() { return reg_dev.GUID; }
...
void Supla::RegisterDevice::fillGUIDText(char text[37]) {
  ...
  snprintf(
      ...
      reg_dev.GUID[0], reg_dev.GUID[1], reg_dev.GUID[2], reg_dev.GUID[3],
      reg_dev.GUID[4], reg_dev.GUID[5], reg_dev.GUID[6], reg_dev.GUID[7],
      reg_dev.GUID[8], reg_dev.GUID[9], reg_dev.GUID[10], reg_dev.GUID[11],
      reg_dev.GUID[12], reg_dev.GUID[13], reg_dev.GUID[14], reg_dev.GUID[15]);
}

const char *Supla::RegisterDevice::getAuthKey() { return reg_dev.AuthKey; }

const char *Supla::RegisterDevice::getSoftVer() { return reg_dev.SoftVer; }

const char *Supla::RegisterDevice::getName() { return reg_dev.Name; }
...
const char *Supla::RegisterDevice::getEmail() { return reg_dev.Email; }
  ...
  if (reg_dev.ServerName[0] != '\0') {
    ...
    if (serverLength > suplaPublicServerSuffixLength) {
      if (strncmpInsensitive(
              ...
              suplaPublicServerSuffix, suplaPublicServerSuffixLength) == 0) {
        return true;
      }
    }
  }
...
int16_t Supla::RegisterDevice::getProductId() { return reg_dev.ProductID; }

int Supla::RegisterDevice::getChannelCount() { return reg_dev.channel_count; }
