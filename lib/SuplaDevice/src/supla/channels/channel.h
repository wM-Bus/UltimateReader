...
public:
  ...
  void setNewValue(uint8_t red, uint8_t green, uint8_t blue,
  ...
  static enum HvacCoolSubfunctionFlag
  getHvacFlagCoolSubfunction(THVACValue *hvacValue);
  ...
  virtual bool
  getExtValueAsElectricityMeter(TElectricityMeter_ExtendedValue_V3 *out);
